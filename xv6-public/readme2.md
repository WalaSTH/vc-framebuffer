...
(imagen de tile roca)
Lo primero es dibujar una roca como esta, que aparece en todo el mapa. Se dibuja imitando la orignal, aunque esta simplificada para acelerar el trabajo. Para dibujarla utilizamos syscalls creadas anteriormente para la parte 3. 
